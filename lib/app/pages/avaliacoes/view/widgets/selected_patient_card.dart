...
import '../../../gerenciar_pacientes/view/store/edit_patient_store.dart';
        ...
        onTap: () {
          if (patient != null) {
            showDialog(
              ...
              builder: (c) {
                return Dialog(
                  child: FichaMedicaWidget(
                    editStore: getIt<EditPatientsStore>(),
                    manageStore: getIt<ManagePatientsStore>(),
